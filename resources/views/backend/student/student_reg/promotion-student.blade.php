        ...
        <div class="row">
          ...
          <section class="col-lg-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                 <form  method="post" action="{{ route('students.reg.promotion.store',$editdata->student_id) }}" id="addForm" enctype="multipart/form-data">
                 	@csrf
	                ...
	                <input style="margin-top: 32px" type="submit" class="btn btn-primary btn-sm" value="{{ (isset($editdata))?'Promotion':'Submit' }}">
	              </form>
              </div>
            </div>
          </section>
