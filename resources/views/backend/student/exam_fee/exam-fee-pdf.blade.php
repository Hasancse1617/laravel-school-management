...
<body>
	<div class="container">
	   <div class="row">
	   	<div class="col-md-12">
	   		<table width="80%">
	   			<tr>
	   				...
	   				<td class="text-center"><img src="{{ url('public/upload/student_images/'.$details['student']['image'])}}" alt="" style="height:70px; width:70px"></td>
	   			</tr>
	   		</table>
	   	</div>
	   	...
	   	<div class="col-md-12">
	   		@php
                $registrationfee = App\Model\FeeCategoryAmount::where('fee_category_id','3')->where('class_id',$details->class_id)->first();
