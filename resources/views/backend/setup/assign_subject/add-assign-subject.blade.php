            ...
            <div class="card">
              <div class="card-header">
                ...
                @else
                  Add Assign Subject
                @endif
                  <a href="{{ route('setups.assign.subject.view') }}" class="btn btn-success float-right"><i class="fas fa-list"></i>&nbsp;Fee Amount List</a>
                </h3>
              </div>
              <div class="card-body">
                 <form  method="post" action="{{ route('setups.assign.subject.store') }}" id="addForm">
                 	@csrf
                 	<div class="add_item">
                 		<div class="form-row">
